...
public class GLHalfedgeStructureOld extends GLDisplayable{
	...
	public GLHalfedgeStructureOld(HalfEdgeStructure halfEdgeStructure, int smoothingSteps) {
		super(halfEdgeStructure.getVertices().size());
		this.rounds = smoothingSteps;
		init(halfEdgeStructure);
	}
	
	public GLHalfedgeStructureOld(HalfEdgeStructure halfEdgeStructure) {
		super(halfEdgeStructure.getVertices().size());
		init(halfEdgeStructure);
	}
